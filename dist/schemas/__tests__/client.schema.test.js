...
describe("Client Schema", () => {
  describe("createClientSchema", () => {
    it("deve validar cliente v\xE1lido", () => {
      const validClient = {
        name: "Jo\xE3o Silva",
    ...
    it("deve rejeitar CPF inv\xE1lido", () => {
      const invalidClient = {
        name: "Jo\xE3o Silva",
    ...
    it("deve normalizar telefone removendo caracteres n\xE3o num\xE9ricos", () => {
      const client = {
        name: "Jo\xE3o Silva",
        phone: "(11) 98765-4321"
      };
      ...
      if (result.success) {
        globalExpect(result.data.phone).toBe("11987654321");
      }
    });
  ...
  describe("updateClientSchema", () => {
    it("deve validar update v\xE1lido", () => {
      const update = {
        id: "123e4567-e89b-12d3-a456-426614174000",
        name: "Jo\xE3o Silva Atualizado"
      };
      const result = updateClientSchema.safeParse(update);
      globalExpect(result.success).toBe(true);
    });
    it("deve rejeitar ID inv\xE1lido", () => {
      const update = {
        id: "invalid-uuid",
        name: "Jo\xE3o Silva"
      };
