...
g.close = "";
function h() {
  let e = typeof process != "undefined" ? process : void 0, n2 = (e == null ? void 0 : e.env) || {}, a = n2.FORCE_TTY !== "false", i = (e == null ? void 0 : e.argv) || [];
  return !("NO_COLOR" in n2 || i.includes("--no-color")) && ("FORCE_COLOR" in n2 || i.includes("--color") || (e == null ? void 0 : e.platform) === "win32" || a && n2.TERM !== "dumb" || "CI" in n2) || typeof window != "undefined" && !!window.chrome;
}
function f() {
  let e = h(), n2 = (r, t, u, o) => {
    let l = "", s = 0;
...
var serialize$4 = (collection, config2, indentation, depth, refs, printer2) => {
  ...
  return (config2.min ? "" : name + SPACE$1) + (OBJECT_NAMES.has(name) ? `{${printObjectProperties(isNamedNodeMap(collection) ? [...collection].reduce((props, attribute) => {
    ...
    return props;
  }, {}) : __spreadValues({}, collection), config2, indentation, depth, refs, printer2)}}` : `[${printListItems([...collection], config2, indentation, depth, refs, printer2)}]`);
};
var plugin$4 = {
...
function requireReactIs_production_min() {
  ...
  reactIs_production_min.isValidElementType = function(a) {
    return "string" === typeof a || "function" === typeof a || a === d2 || a === f2 || a === e || a === m || a === n2 || a === t || "object" === typeof a && null !== a && (a.$$typeof === q || a.$$typeof === p || a.$$typeof === g2 || a.$$typeof === h2 || a.$$typeof === l || a.$$typeof === u || void 0 !== a.getModuleId) ? true : false;
  };
...
var ErrorPlugin = {
  ...
  serialize(val, config2, indentation, depth, refs, printer2) {
    ...
    refs = [...refs, val];
    const hitMaxDepth = ++depth > config2.maxDepth;
    const _a = val, { message, cause } = _a, rest = __objRest(_a, ["message", "cause"]);
    const entries = __spreadValues(__spreadValues(__spreadValues({
      message
    }, typeof cause !== "undefined" ? { cause } : {}), val instanceof AggregateError ? { errors: val.errors } : {}), rest);
...
function getConfig(options) {
  ...
  return {
    ...
    printShadowRoot: (_h = options == null ? void 0 : options.printShadowRoot) != null ? _h : true,
...
function stringify(object2, maxDepth = 10, _a = {}) {
  var _b = _a, { maxLength } = _b, options = __objRest(_b, ["maxLength"]);
  const MAX_LENGTH = maxLength != null ? maxLength : 1e4;
  let result;
  try {
    result = format(object2, __spreadValues({
      maxDepth,
      escapeString: false,
      plugins: PLUGINS
    }, options));
  ...
  return result.length >= MAX_LENGTH && maxDepth > 1 ? stringify(object2, Math.floor(Math.min(maxDepth, Number.MAX_SAFE_INTEGER) / 2), __spreadValues({
    maxLength
  }, options)) : result;
}
...
function diffLinesRaw(aLines, bLines, options) {
  var _a, _b;
  const truncate3 = (_a = options === null || options === void 0 ? void 0 : options.truncateThreshold) != null ? _a : false;
...
function diffStrings(a, b, options) {
  ...
  if (truncate3) {
    ...
    const _a2 = aMultipleLines ? `${a.split(aNewLineSymbol, truncateThreshold).join(aNewLineSymbol)}
` : a;
...
function createMockInstance(options = {}) {
  ...
  const mock = createMock(__spreadValues({
    config: config2,
    state
  }, options));
  const mockLength = (_a = (_ref = mockImplementation || originalImplementation) === null || _ref === void 0 ? void 0 : _ref.length) != null ? _a : 0;
  ...
  if (val instanceof Error && "toJSON" in val && typeof val.toJSON === "function") {
    ...
    if (jsonValue && jsonValue !== val && typeof jsonValue === "object") {
      if (typeof val.message === "string") {
        safe(() => {
          var _a;
          return (_a = jsonValue.message) != null ? _a : jsonValue.message = normalizeErrorMessage(val.message);
        });
      }
      if (typeof val.stack === "string") {
        safe(() => {
          var _a;
          return (_a = jsonValue.stack) != null ? _a : jsonValue.stack = val.stack;
        });
      }
      if (typeof val.name === "string") {
        safe(() => {
          var _a;
          return (_a = jsonValue.name) != null ? _a : jsonValue.name = val.name;
        });
      }
      if (val.cause != null) {
        safe(() => {
          var _a;
          return (_a = jsonValue.cause) != null ? _a : jsonValue.cause = serializeValue(val.cause, seen);
        });
      }
    }
...
function processError(_err, diffOptions, seen = /* @__PURE__ */ new WeakSet()) {
  ...
  if (err.showDiff || err.showDiff === void 0 && err.expected !== void 0 && err.actual !== void 0) {
    err.diff = printDiffOrStringify(err.actual, err.expected, __spreadValues(__spreadValues({}, diffOptions), err.diffOptions));
  }
...
function isErrorEqual(a, b, aStack, bStack, customTesters, hasKey2) {
  ...
  result && (result = eq(__spreadValues({}, a), __spreadValues({}, b), aStack, bStack, customTesters, hasKey2));
  return result;
}
...
function setState(state, expect2) {
  ...
  const results = Object.defineProperties(current, __spreadValues(__spreadValues({}, Object.getOwnPropertyDescriptors(current)), Object.getOwnPropertyDescriptors(state)));
...
var ObjectContaining = class extends AsymmetricMatcher3 {
  ...
  asymmetricMatch(other, customTesters) {
    ...
    for (const property of properties) {
      ...
      const value = (_a = (_Object$getOwnPropert2 = Object.getOwnPropertyDescriptor(this.sample, property)) === null || _Object$getOwnPropert2 === void 0 ? void 0 : _Object$getOwnPropert2.value) != null ? _a : this.sample[property];
      const otherValue = (_b = (_Object$getOwnPropert3 = Object.getOwnPropertyDescriptor(other, property)) === null || _Object$getOwnPropert3 === void 0 ? void 0 : _Object$getOwnPropert3.value) != null ? _b : other[property];
...
function recordAsyncExpect(_test2, promise, assertion, error) {
  ...
  if (test5 && promise instanceof Promise) {
    ...
    let resolved = false;
    (_a = test5.onFinished) != null ? _a : test5.onFinished = [];
  ...
  function create(context) {
    ...
    for (const key of keys2) {
      Object.defineProperty(chain2, key, { get() {
        return create(__spreadProps(__spreadValues({}, context), {
          [key]: true
        }));
      } });
    }
...
function mergeScopedFixtures(testFixtures, scopedFixtures) {
  ...
  testFixtures.forEach((fixture) => {
    const useFixture = scopedFixturesMap[fixture.prop] || __spreadValues({}, fixture);
...
function mergeContextFixtures(fixtures, context, runner2) {
  ...
  const fixtureArray = Object.entries(fixtures).map(([prop, value]) => {
    ...
    if (Array.isArray(value) && value.length >= 2 && isObject(value[1]) && Object.keys(value[1]).some((key) => fixtureOptionKeys.includes(key))) {
      ...
      fixtureItem.value = fixtureItem.injected ? (_a = (_runner$injectValue = runner2.injectValue) === null || _runner$injectValue === void 0 ? void 0 : _runner$injectValue.call(runner2, prop)) != null ? _a : userValue : userValue;
    }
    ...
    function resolveFixtures() {
      return __async(this, null, function* () {
        for (const fixture of pendingFixtures) {
          ...
          const resolvedValue = yield resolveFixtureValue(runner2, fixture, context, cleanupFnArray);
...
function resolveFixtureValue(runner2, fixture, context, cleanupFnArray) {
  ...
  if (!fixture.isFn) {
    var _fixture$prop;
    (_a = fileContext[_fixture$prop = fixture.prop]) != null ? _a : fileContext[_fixture$prop] = fixture.value;
    if (workerContext) {
      var _fixture$prop2;
      (_b = workerContext[_fixture$prop2 = fixture.prop]) != null ? _b : workerContext[_fixture$prop2] = fixture.value;
    }
...
function resolveFixtureFunction(fixtureFn, context, cleanupFnArray) {
  return __async(this, null, function* () {
    ...
    const fixtureReturn = fixtureFn(context, (useFnArg) => __async(null, null, function* () {
      isUseFnArgResolved = true;
      useFnArgPromise.resolve(useFnArg);
      const useReturnPromise = createDefer();
      cleanupFnArray.push(() => __async(null, null, function* () {
...
function afterAll(fn2, timeout) {
  ...
  return getCurrentSuite().on("afterAll", withTimeout(fn2, timeout != null ? timeout : getDefaultHookTimeout(), true, new Error("STACK_TRACE_ERROR")));
}
function beforeEach(fn2, timeout = getDefaultHookTimeout()) {
  assertTypes(fn2, '"beforeEach" callback', ["function"]);
  const stackTraceError = new Error("STACK_TRACE_ERROR");
  const runner2 = getRunner();
  return getCurrentSuite().on("beforeEach", Object.assign(withTimeout(withFixtures(runner2, fn2), timeout != null ? timeout : getDefaultHookTimeout(), true, stackTraceError, abortIfTimeout), {
    [CLEANUP_TIMEOUT_KEY]: timeout,
    [CLEANUP_STACK_TRACE_KEY]: stackTraceError
  }));
}
function afterEach(fn2, timeout) {
  ...
  const runner2 = getRunner();
  return getCurrentSuite().on("afterEach", withTimeout(withFixtures(runner2, fn2), timeout != null ? timeout : getDefaultHookTimeout(), true, new Error("STACK_TRACE_ERROR"), abortIfTimeout));
}
var onTestFailed = createTestHook("onTestFailed", (test5, handler, timeout) => {
  test5.onFailed || (test5.onFailed = []);
  test5.onFailed.push(withTimeout(handler, timeout != null ? timeout : getDefaultHookTimeout(), true, new Error("STACK_TRACE_ERROR"), abortIfTimeout));
});
var onTestFinished = createTestHook("onTestFinished", (test5, handler, timeout) => {
  test5.onFinished || (test5.onFinished = []);
  test5.onFinished.push(withTimeout(handler, timeout != null ? timeout : getDefaultHookTimeout(), true, new Error("STACK_TRACE_ERROR"), abortIfTimeout));
});
...
function createSuiteCollector(name, factory = () => {
  ...
  const task = function(name2 = "", options = {}) {
    ...
    const timeout = (_a = options === null || options === void 0 ? void 0 : options.timeout) != null ? _a : runner.config.testTimeout;
    const task2 = {
      id: "",
      name: name2,
      ...
      file: void 0,
      timeout,
      retry: (_b = options.retry) != null ? _b : runner.config.retry,
      repeats: options.repeats,
      mode: options.only ? "only" : options.skip ? "skip" : options.todo ? "todo" : "run",
      meta: (_c = options.meta) != null ? _c : /* @__PURE__ */ Object.create(null),
      annotations: [],
      artifacts: []
    };
  ...
  const test5 = createTest(function(name2, optionsOrFn, timeoutOrTest) {
    ...
    const test6 = task(formatName(name2), __spreadProps(__spreadValues(__spreadValues({}, this), options), {
      handler
    }));
    test6.type = "test";
  });
  ...
  function collect(file) {
    return __async(this, null, function* () {
      ...
      if (factory) {
        yield runWithSuite(collector, () => factory(test5));
      }
      const allChildren = [];
...
function withAwaitAsyncAssertions(fn2, task) {
  return (...args) => __async(null, null, function* () {
    const fnResult = yield fn2(...args);
    if (task.promises) {
      const result = yield Promise.allSettled(task.promises);
...
function createSuite() {
  function suiteFn(name, factoryOrOptions, optionsOrFactory) {
    ...
    options = __spreadProps(__spreadValues(__spreadValues({}, currentSuite === null || currentSuite === void 0 ? void 0 : currentSuite.options), options), {
      shuffle: (_c = (_b = (_a = this.shuffle) != null ? _a : options.shuffle) != null ? _b : currentSuite === null || currentSuite === void 0 || (_currentSuite$options = currentSuite.options) === null || _currentSuite$options === void 0 ? void 0 : _currentSuite$options.shuffle) != null ? _c : runner === null || runner === void 0 ? void 0 : runner.config.sequence.shuffle
    });
...
function createTaskCollector(fn2, context) {
  ...
  taskFn.extend = function(fixtures) {
    ...
    return createTest(function(name, optionsOrFn, optionsOrTest) {
      ...
      const context2 = __spreadValues({}, this);
      if (scopedFixtures) {
...
function createTestContext(test5, runner2) {
  ...
  context.skip = (condition, note) => {
    ...
    (_a = test5.result) != null ? _a : test5.result = { state: "skip" };
  ...
  context.annotate = (message, type3, attachment) => {
    ...
    return recordAsyncOperation(test5, recordArtifact(test5, {
      ...
      annotation
    }).then((_0) => __async(null, [_0], function* ({ annotation: annotation2 }) {
      if (!runner2.onTestAnnotate) {
        throw new Error(`Test runner doesn't support test annotations.`);
      }
      yield finishSendTasksUpdate(runner2);
      const resolvedAnnotation = yield runner2.onTestAnnotate(test5, annotation2);
  ...
  context.onTestFailed = (handler, timeout) => {
    test5.onFailed || (test5.onFailed = []);
    test5.onFailed.push(withTimeout(handler, timeout != null ? timeout : runner2.config.hookTimeout, true, new Error("STACK_TRACE_ERROR"), (_, error) => abortController.abort(error)));
  };
  context.onTestFinished = (handler, timeout) => {
    test5.onFinished || (test5.onFinished = []);
    test5.onFinished.push(withTimeout(handler, timeout != null ? timeout : runner2.config.hookTimeout, true, new Error("STACK_TRACE_ERROR"), (_, error) => abortController.abort(error)));
  };
...
function finishSendTasksUpdate(runner2) {
  return __async(this, null, function* () {
    sendTasksUpdate(runner2);
    yield Promise.all(pendingTasksUpdates);
  });
}
...
function recordArtifact(task, artifact) {
  return __async(this, null, function* () {
    const runner2 = getRunner();
    ...
    yield finishSendTasksUpdate(runner2);
    const resolvedArtifact = yield runner2.onTestArtifactRecord(task, artifact);
...
function saveInlineSnapshots(environment, snapshots) {
  return __async(this, null, function* () {
    ...
    yield Promise.all(Array.from(files).map((file) => __async(null, null, function* () {
...
function saveRawSnapshots(environment, snapshots) {
  return __async(this, null, function* () {
    yield Promise.all(snapshots.map((snap) => __async(null, null, function* () {
      if (!snap.readonly) {
...
function serialize2(val, indent = 2, formatOverrides = {}) {
  return normalizeNewlines(format(val, __spreadValues({
    escapeRegex,
    indent,
...
`;
    ...
    yield environment.saveSnapshotFile(snapshotPath, content);
  });
}
...
var SnapshotState = class _SnapshotState {
  constructor(testFilePath, snapshotPath, snapshotContent, options) {
    ...
    this._initialData = __spreadValues({}, data);
    this._snapshotData = __spreadValues({}, data);
    this._dirty = dirty;
...
${JSON.stringify(stacks)}`);
      ...
      this._inlineSnapshotStacks.push(__spreadProps(__spreadValues({}, stack), {
        testId,
        snapshot: receivedSerialized
      }));
    }
...
var SnapshotClient = class {
  ...
  setup(filepath, options) {
    return __async(this, null, function* () {
      if (this.snapshotStateMap.has(filepath)) {
        return;
      }
      this.snapshotStateMap.set(filepath, yield SnapshotState.create(filepath, options));
    });
  }
  finish(filepath) {
    return __async(this, null, function* () {
      const state = this.getSnapshotState(filepath);
      const result = yield state.pack();
  ...
  assert(options) {
    ...
    if (typeof properties === "object") {
      ...
      try {
        ...
        const pass2 = (_a = (_this$options$isEqual = (_this$options = this.options).isEqual) === null || _this$options$isEqual === void 0 ? void 0 : _this$options$isEqual.call(_this$options, received, properties)) != null ? _a : false;
        if (!pass2) {
  ...
  assertRaw(options) {
    return __async(this, null, function* () {
      ...
      if (rawSnapshot.content == null) {
        ...
        rawSnapshot.content = (_a = yield snapshotState.environment.readSnapshotFile(rawSnapshot.file)) != null ? _a : void 0;
      }
...
// node_modules/vitest/dist/chunks/vi.BiaV1qII.js
var unsupported = [
  "matchSnapshot",
  "toMatchSnapshot",
...
function createExpectPoll(expect2) {
  return function poll(fn2, options = {}) {
    var _a, _b, _c, _d;
    const defaults = (_b = (_a = getWorkerState().config.expect) == null ? void 0 : _a.poll) != null ? _b : {};
    const { interval = (_c = defaults.interval) != null ? _c : 50, timeout = (_d = defaults.timeout) != null ? _d : 1e3, message } = options;
    ...
    const proxy = new Proxy(assertion, { get(target, key, receiver) {
      ...
      return function(...args) {
        ...
        const promise = () => new Promise((resolve3, reject) => {
          ...
          const check = () => __async(null, null, function* () {
            try {
              ...
              resolve3(yield assertionFunction.call(assertion, ...args));
              clearTimeout3(intervalId);
              clearTimeout3(timeoutId);
            } catch (err) {
              lastError = err;
              if (!chai_exports.util.flag(assertion, "_isLastPollAttempt")) intervalId = setTimeout3(check, interval);
            }
          });
          timeoutId = setTimeout3(() => {
            clearTimeout3(intervalId);
            chai_exports.util.flag(assertion, "_isLastPollAttempt", true);
        ...
        let awaited = false;
        (_a2 = test5.onFinished) != null ? _a2 : test5.onFinished = [];
        test5.onFinished.push(() => {
          if (!awaited) {
...
function recordAsyncExpect2(_test2, promise, assertion, error) {
  ...
  if (test5 && promise instanceof Promise) {
    ...
    test5.onFinished.push(() => {
      var _a2;
      if (!resolved) {
        const stack = (((_a2 = globalThis.__vitest_worker__) == null ? void 0 : _a2.onFilterStackTrace) || ((s) => s || ""))(error.stack);
        console.warn([
          `Promise returned by \`${assertion}\` was not awaited. `,
          "Vitest currently auto-awaits hanging assertions at the end of the test, but this will cause the test to fail in Vitest 3. ",
          "Please remember to await the assertion.\n",
...
var SnapshotPlugin = (chai, utils) => {
  ...
  utils.addMethod(chai.Assertion.prototype, "toMatchFileSnapshot", function(file, message) {
    ...
    const errorMessage = utils.flag(this, "message");
    return recordAsyncExpect2(test5, getSnapshotClient().assertRaw(__spreadValues({
      received: expected,
      message,
      isInline: false,
      rawSnapshot: { file },
      errorMessage
    }, getTestNames(test5))), createAssertionMessage2(utils, this), error);
  });
...
function requireFakeTimersSrc() {
  ...
  function withGlobal(_global) {
    ...
    class FakePerformanceEntry {
      ...
      toJSON() {
        return JSON.stringify(__spreadValues({}, this));
      }
    }
      ...
      for (i = 0, l = clock.methods.length; i < l; i++) {
        ...
        if (clock.timersPromisesModuleMethods !== void 0) {
          if (nameOfMethodToReplace === "setTimeout") {
            ...
            timersPromisesModule.setTimeout = (delay, value, options = {}) => new Promise((resolve3, reject) => {
              const abort = () => {
...
var FakeTimers = class {
  ...
  runAllTimersAsync() {
    return __async(this, null, function* () {
      if (this._checkFakeTimers()) yield this._clock.runAllAsync();
    });
  }
  ...
  runOnlyPendingTimersAsync() {
    return __async(this, null, function* () {
      if (this._checkFakeTimers()) yield this._clock.runToLastAsync();
    });
  }
  ...
  advanceTimersByTimeAsync(msToRun) {
    return __async(this, null, function* () {
      if (this._checkFakeTimers()) yield this._clock.tickAsync(msToRun);
    });
  }
  ...
  setSystemTime(now3) {
    ...
    if (this._fakingTime) this._clock.setSystemTime(date);
      ...
      this._fakingDate = date != null ? date : new Date(this.getRealSystemTime());
...
function createVitest() {
  ...
  const utils = {
    useFakeTimers(config2) {
      var _a2, _b, _c, _d;
      if (isChildProcess()) {
        if (((_a2 = config2 == null ? void 0 : config2.toFake) == null ? void 0 : _a2.includes("nextTick")) || ((_d = (_c = (_b = state().config) == null ? void 0 : _b.fakeTimers) == null ? void 0 : _c.toFake) == null ? void 0 : _d.includes("nextTick"))) throw new Error('vi.useFakeTimers({ toFake: ["nextTick"] }) is not supported in node:child_process. Use --pool=threads if mocking nextTick is required.');
      }
      if (config2) timers().configure(__spreadValues(__spreadValues({}, state().config.fakeTimers), config2));
    ...
    runOnlyPendingTimersAsync() {
      return __async(this, null, function* () {
        yield timers().runOnlyPendingTimersAsync();
        return utils;
      });
    },
    runAllTimers() {
    ...
    runAllTimersAsync() {
      return __async(this, null, function* () {
        yield timers().runAllTimersAsync();
        return utils;
      });
    },
    runAllTicks() {
    ...
    advanceTimersByTimeAsync(ms) {
      return __async(this, null, function* () {
        yield timers().advanceTimersByTimeAsync(ms);
        return utils;
      });
    },
    ...
    advanceTimersToNextTimerAsync() {
      return __async(this, null, function* () {
        yield timers().advanceTimersToNextTimerAsync();
        return utils;
      });
    },
    advanceTimersToNextFrame() {
    ...
    setConfig(config2) {
      if (!_config) _config = __spreadValues({}, state().config);
...
var intToChar4 = new Uint8Array(64);
var charToInt4 = new Uint8Array(128);
for (let i = 0; i < chars4.length; i++) {
  let c = chars4.charCodeAt(i);
  intToChar4[i] = c, charToInt4[c] = i;
}
...
describe("AppError", () => {
  it("deve criar erro com mensagem e status code padr\xE3o", () => {
    const error = new AppError("Erro de teste");
    globalExpect(error.message).toBe("Erro de teste");
    globalExpect(error.statusCode).toBe(400);
    globalExpect(error.isOperational).toBe(true);
  });
  it("deve criar erro com status code customizado", () => {
    const error = new AppError("N\xE3o encontrado", 404);
    globalExpect(error.message).toBe("N\xE3o encontrado");
    globalExpect(error.statusCode).toBe(404);
  });
  it("deve criar erro com c\xF3digo e detalhes", () => {
    const details = { field: "email", reason: "j\xE1 existe" };
    const error = new AppError("Erro", 409, "CONFLICT", details);
    globalExpect(error.code).toBe("CONFLICT");
    globalExpect(error.details).toEqual(details);
  });
  describe("M\xE9todos est\xE1ticos", () => {
    it("badRequest deve criar erro 400", () => {
      const error = AppError.badRequest("Requisi\xE7\xE3o inv\xE1lida");
      globalExpect(error.statusCode).toBe(400);
      globalExpect(error.code).toBe("BAD_REQUEST");
      globalExpect(error.message).toBe("Requisi\xE7\xE3o inv\xE1lida");
    });
    it("unauthorized deve criar erro 401", () => {
      const error = AppError.unauthorized();
      globalExpect(error.statusCode).toBe(401);
      globalExpect(error.code).toBe("UNAUTHORIZED");
    });
    it("forbidden deve criar erro 403", () => {
      const error = AppError.forbidden();
      globalExpect(error.statusCode).toBe(403);
      globalExpect(error.code).toBe("FORBIDDEN");
    });
    it("notFound deve criar erro 404", () => {
      const error = AppError.notFound("Recurso n\xE3o encontrado");
      globalExpect(error.statusCode).toBe(404);
      globalExpect(error.code).toBe("NOT_FOUND");
    });
    it("conflict deve criar erro 409", () => {
      const error = AppError.conflict("Conflito");
      globalExpect(error.statusCode).toBe(409);
      globalExpect(error.code).toBe("CONFLICT");
    });
    it("validation deve criar erro 422", () => {
      const details = { email: "inv\xE1lido" };
      const error = AppError.validation("Erro de valida\xE7\xE3o", details);
      globalExpect(error.statusCode).toBe(422);
      globalExpect(error.code).toBe("VALIDATION_ERROR");
      globalExpect(error.details).toEqual(details);
    });
    it("internal deve criar erro 500", () => {
      const error = AppError.internal();
      globalExpect(error.statusCode).toBe(500);
      globalExpect(error.code).toBe("INTERNAL_ERROR");
    });
  });
});
