...
var ValidRefreshTokenUserService_exports = {};
__export(ValidRefreshTokenUserService_exports, {
  ValidRefreshTokenUserService: () => ValidRefreshTokenUserService
});
module.exports = __toCommonJS(ValidRefreshTokenUserService_exports);
...
function ValidRefreshTokenUserService(_0) {
  return __async(this, arguments, function* ({
    ...
    const refreshToken = `${validToken.user_id}${import_node_crypto.default.randomBytes(64).toString("hex")}`;
