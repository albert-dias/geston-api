...
// src/services/products/UpdateStockProductEnterpriseService.ts
var UpdateStockProductEnterpriseService_exports = {};
__export(UpdateStockProductEnterpriseService_exports, {
  UpdateStockProductEnterpriseService: () => UpdateStockProductEnterpriseService
});
module.exports = __toCommonJS(UpdateStockProductEnterpriseService_exports);
...
// src/services/products/UpdateStockProductEnterpriseService.ts
function UpdateStockProductEnterpriseService(_0) {
  return __async(this, arguments, function* ({
    ...
    const user = yield prisma.productsEnterprise.update({
...
0 && (module.exports = {
  UpdateStockProductEnterpriseService
});
