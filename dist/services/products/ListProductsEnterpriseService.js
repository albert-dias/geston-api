...
// src/services/products/ListProductsEnterpriseService.ts
var ListProductsEnterpriseService_exports = {};
__export(ListProductsEnterpriseService_exports, {
  ListServicesEnterpriseService: () => ListServicesEnterpriseService
});
module.exports = __toCommonJS(ListProductsEnterpriseService_exports);
...
function ListServicesEnterpriseService(_0) {
  return __async(this, arguments, function* ({
    ...
    const user = yield prisma.servicesEnterprise.findMany({
      where: { enterprise_id }
    });
    if (!user) {
