...
// src/services/products/UpdateProductEnterpriseService.ts
var UpdateProductEnterpriseService_exports = {};
__export(UpdateProductEnterpriseService_exports, {
  UpdateServiceEnterpriseService: () => UpdateServiceEnterpriseService
});
module.exports = __toCommonJS(UpdateProductEnterpriseService_exports);
...
function UpdateServiceEnterpriseService(_0) {
  return __async(this, arguments, function* ({
    ...
    const user = yield prisma.servicesEnterprise.update({
